...
#define DEFAULT_MAX_CONNECTIONS         500    // WM - Default value for -maxconnections= parameter.
#define MIN_CONNECTIONS                 50      // WM - Lowest value we allow for -maxconnections= (never ever set less than 2!).
#define MAX_CONNECTIONS                 1000   // WM - Max allowed value for -maxconnections= parameter.  Getting kinda excessive, eh?

#define DEFAULT_OUTBOUND_CONNECTIONS    50      // WM - Reasonable default of 8 outbound connections for -maxoutbound= parameter.
#define MIN_OUTBOUND_CONNECTIONS        25      // WM - Lowest we allow for -maxoutbound= parameter shall be 4 connections (never ever set below 2).
