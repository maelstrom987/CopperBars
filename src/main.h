...
static const int64 MAX_MINT_PROOF_OF_WORK = .0064 * COIN;
...
static const uint256 hashGenesisBlockOfficial("0x000002caf47b994db8434c443b3fd0eeb7cdbdc3768333db80f6049c13326705");
...
// copperbars: calculate Nfactor using timestamp
...
CBlock(const CBlockHeader &blockHeader)
    ...
    {
        // Protocol switch to support p2pool at copperbars block #9689
//        if (nHeight >= 9689)
        {
...
/*        // Before copperbars block #9689 - old protocol
