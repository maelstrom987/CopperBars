...
unsigned int nStakeTargetSpacing = .265 * 60; //  16 second minute block spacing
int64 nChainStartTime = 1376184687;
...
const string strMessageMagic = "Copperbars Signed Message:\n";
...
// copperbars: increasing Nfactor gradually
...
unsigned char GetNfactor(int64 nTimestamp) {
    ...
    if (n > 255)
        printf("GetNfactor(%11d) - something wrong(n == %d)\n", nTimestamp, n);
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "Copperbars", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Copperbars are born-ed.";
        CTransaction txNew;
        ...
        assert(block.hashMerkleRoot == uint256("0xde0c95ffedd16dc12858992a26fc52e75c8fe14935bc11f6ddaf92f375620df6"));
        block.print();
